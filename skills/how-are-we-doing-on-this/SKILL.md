...
3. A checklist of the next steps.
4. An overview of the goal.

Back each done item with a commit and each next step with where it came from
(plan, PR body, review, failing check, TODO), or mark it inferred. Keep it
short.
